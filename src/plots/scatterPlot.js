  ...
  d3.csv("data/processed/BarChartData.csv", function(data) {
    ...
    if (dataSelectedCities.length>0 && dataSelectedCities[0]!=null){
      ...
      if(order == "top10"){ //prendo le prime 10
        ...
        dataSelectedCities = dataSelectedCities.slice(dataSelectedCities.length-10,dataSelectedCities.length);
      }
      ...
      if(order == "top10"){ //prendo le prime 10
        ...
        dataAllCities = dataAllCities.slice(dataAllCities.length-10,dataAllCities.length);
      }
